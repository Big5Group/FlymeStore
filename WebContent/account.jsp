...
<body>
				...
				<div class="col-xs-6">
					<ul class="top-link">
						...
						<li><a href="myinformation.jsp"> <span
								class="glyphicon glyphicon-envelope"></span> 个人信息
						</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-6">
					...
					<form name="form1" id="ff1" method="post" action="doLoginServlet">
						...
						<div class="form-group">
							<input type="checkbox" id="isUserCookie">&nbsp;&nbsp;十天之内自动登录
						</div>
				...
				<div class="col-md-6">
					...
					<form name="form2" id="ff2" method="post"
						action="doRegisterServlet">
						<div class="form-group">
							<input type="text" class="form-control" placeholder="Name :"
								name="registerName" id="registerName" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							Male <input name="gender" id="gender" type="radio" value="0">
							Female
						</div>
						<div class="form-group">
							<input type="password" class="form-control"
						...
						<div class="form-group">
							<input name="agree" id="agree" type="checkbox"> I agree
							to your website.
						</div>
	...
	<footer>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-md-6">Copyright &copy; 2017.Company name All
						rights reserved.</div>
					<div class="col-md-6">
